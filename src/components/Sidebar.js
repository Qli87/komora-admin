            ...
            <aside className="main-sidebar">
                ...
                <form action="#1" method="get" className="sidebar-form">
                    ...
                    <ul className="sidebar-menu" data-widget="tree">
                        ...
                        <ul className="treeview-menu">
                            <li><a href="#1"><i className="fa fa-circle-o"></i> Level One</a></li>
                            <li className="treeview">
                            <a href="#1"><i className="fa fa-circle-o"></i> Level One
                                <span className="pull-right-container">
                                <i className="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul className="treeview-menu">
                                <li><a href="#1"><i className="fa fa-circle-o"></i> Level Two</a></li>
                                <li className="treeview">
                                <a href="#1"><i className="fa fa-circle-o"></i> Level Two
                                    <span className="pull-right-container">
                                    <i className="fa fa-angle-left pull-right"></i>
                                    </span>
                                </a>
                                <ul className="treeview-menu">
                                    <li><a href="#1"><i className="fa fa-circle-o"></i> Level Three</a></li>
                                    <li><a href="#1"><i className="fa fa-circle-o"></i> Level Three</a></li>
                                </ul>
                                </li>
                            </ul>
                        ...
                        <li><a href="#1"><i className="fa fa-circle-o text-red"></i> <span>Important</span></a></li>
                        <li><a href="#1"><i className="fa fa-circle-o text-yellow"></i> <span>Warning</span></a></li>
                        <li><a href="#1"><i className="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li>
                    </ul>
                </section>
            </aside>
        )
